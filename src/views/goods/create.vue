...
<script>
import { addGoods ,uploadFile ,multipleUpload} from '@/api/goods'
...
export default {
  ...
  methods: {
    ...
    handlePublish: function() {
      ...
      let gallery = []
      for (let pic of this.picList){
        gallery.push(pic.value)
      }
      this.goods.gallery = gallery.toString()
      this.goods.categoryId = this.categoryId
      console.log('this.goods.categoryId = this.categoryId',this.categoryId)
      console.log(this.goods)
      this.$confirm(`确定上架么？`, '提示', {
